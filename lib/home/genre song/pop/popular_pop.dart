...
class PopularPopPage extends StatefulWidget {
  @override
  _PopularPopPageState createState() => _PopularPopPageState();
}
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => DetailPage(
                              imgUrl: pops[index]['imgUrl'],
                              logoUrl: pops[index]['logoUrl'],
                              name: pops[index]['name'],
                              youTube: pops[index]['youTube'],
                              tikTok: pops[index]['tikTok'],
                              title: pops[index]['title'],
